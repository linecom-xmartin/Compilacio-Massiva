...
public class TicFuentesEntornosId implements Serializable {
	...
	public TicFuentesEntornosId() {
		super();
	}

	public TicFuentesEntornosId(@NotNull BigDecimal entidad, @NotNull String entorno,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TicFuentesEntornosId other = (TicFuentesEntornosId) obj;
		if (entidad == null) {
